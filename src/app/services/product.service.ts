...
export class ProductService {
  ...
  getProductsByCategoryId(
    ...
    return this.http.get<ApiResponse>(`${this.apiBaseUrl}/products/category/${categoryId}`);
  }
  getProductsBySubCategoryId(
    ...
    return this.http.get<ApiResponse>(`${this.apiBaseUrl}/products/subcategory/${subcategoryId}`);
  }
